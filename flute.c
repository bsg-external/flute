...
void plottree_matplotlib(Tree t);
...
void plottree_matplotlib(Tree t)
{
  ...
  for (i=0; i<2*t.deg-2; i++) {
    if (i!=0)
      printf(",");
    printf("%d,%d,None",t.branch[i].x,t.branch[t.branch[i].n].x);
  }
  printf("],[");
  for (i=0; i<2*t.deg-2; i++) {
    if (i!=0)
      printf(",");
    printf("%d,%d,None",t.branch[i].y,t.branch[t.branch[i].n].y);
  }
  printf("])\n");
  printf("plt.xlim(plt.xlim()[0]-1,plt.xlim()[1]+1);");
  printf("plt.ylim(plt.ylim()[0]-1,plt.ylim()[1]+1);");
